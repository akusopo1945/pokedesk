...
export default function TopBar() {
  ...
  return (
    <header className="h-14 bg-pokedex-card/80 backdrop-blur-sm border-b border-pokedex-surface flex items-center justify-between px-5 titlebar-drag">
      {/* Left: Pet info */}
      ...
      <div className="flex items-center gap-4 titlebar-no-drag">
        ...
        <div className="flex items-center gap-1 ml-2">
          <button
            ...
            className="w-7 h-7 rounded hover:bg-pokedex-surface flex items-center justify-center text-pokedex-muted hover:text-white transition-colors"
          >
            ─
          </button>
          <button
            onClick={() => window.electronAPI?.close()}
            className="w-7 h-7 rounded hover:bg-red-500/80 flex items-center justify-center text-pokedex-muted hover:text-white transition-colors"
          >
            ✕
          </button>
        </div>
